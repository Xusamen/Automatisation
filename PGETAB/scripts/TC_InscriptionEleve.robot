...
*** Test Cases ***
Cas de test
    [Documentation]    Automatisation du cas de test  Inscription Eleve
    ...
    And saisis "07/12/2002" dans le champ "champ_date_de_naissance"
    ...
    And pause	5s
    And saisis	CAMARA	champ_recherche_nom
    And saisis	Rahim	champ_recherche_prenom
