...
${OBTENU}      ${CURDIR}${/}..${/}fichiers_json${/}TC_CalculMoyennePeriode${/}resultat_obtenu.json
${ATTENDU}     ${CURDIR}${/}..${/}fichiers_json${/}TC_CalculMoyennePeriode${/}resultat_attendu.json
${REQUETE}    
...            SELECT
...                 el.NOM_ELV,
...                 el.PRENOM_ELV,
...
Calcul de moyenne periode
    [Documentation]    Automatisation cas de test calcul de moyenne periode
    lance pgetab
    pause	10s
